...
MODEL_INFO = {
        ...
        "keys": ["AMD", "META", "DEXCHUS", "DEXUSUK", "SP500", "DJIA", "NASDAQCOM"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["AMD", "META", "DEXCHUS", "DEXUSUK", "SP500", "DJIA", "NASDAQCOM"]]
}
